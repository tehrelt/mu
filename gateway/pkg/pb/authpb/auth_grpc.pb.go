...
const (
	...
	AuthService_HasAdmin_FullMethodName  = "/auth.AuthService/HasAdmin"
)
...
type AuthServiceClient interface {
	...
	HasAdmin(ctx context.Context, in *HasAdminRequest, opts ...grpc.CallOption) (*HasAdminResponse, error)
}
...
func (c *authServiceClient) HasAdmin(ctx context.Context, in *HasAdminRequest, opts ...grpc.CallOption) (*HasAdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HasAdminResponse)
	err := c.cc.Invoke(ctx, AuthService_HasAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	HasAdmin(context.Context, *HasAdminRequest) (*HasAdminResponse, error)
...
func (UnimplementedAuthServiceServer) HasAdmin(context.Context, *HasAdminRequest) (*HasAdminResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HasAdmin not implemented")
}
...
func _AuthService_HasAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HasAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).HasAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_HasAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).HasAdmin(ctx, req.(*HasAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HasAdmin",
			Handler:    _AuthService_HasAdmin_Handler,
		},
	},
